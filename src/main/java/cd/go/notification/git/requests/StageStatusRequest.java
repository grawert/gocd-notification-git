...
package cd.go.notification.git.requests;
...
import cd.go.notification.git.executors.StageStatusRequestExecutor;
import cd.go.notification.git.utils.DefaultDateTypeAdapter;
...
public class StageStatusRequest {
    ...
    public RequestExecutor executor(PluginSettings pluginSettings, ServerInfoRequest serverInfoRequest) throws ServerRequestFailedException {
        return new StageStatusRequestExecutor(this, pluginSettings, serverInfoRequest);
    }
